...
set WDIR=%EXEC_DIR%
:findBaseDir
IF NOT EXIST "%WDIR%"\.mvn goto baseDirFound
cd ..
...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" goto endDetectBaseDir

@REM echo MAVEN_PROJECTBASEDIR=%MAVEN_PROJECTBASEDIR%
@REM echo MAVEN_PROJECTBASEDIR
